...
export const tasks: Task[] = [
  {
    ...
    links: { meetingId: "m_1", prdId: "d_pm_1", graphNodeId: "g_eng", featureRequestId: "fr_1" }, createdAt: ago(days(5)), updatedAt: ago(days(2)),
  },
  {
    ...
    links: { meetingId: "m_1", graphNodeId: "g_cs" }, createdAt: ago(mins(30)), updatedAt: ago(mins(8)),
  },
  {
    ...
    links: { meetingId: "m_1", prdId: "d_pm_1", graphNodeId: "g_eng", featureRequestId: "fr_1" }, createdAt: ago(days(4)), updatedAt: ago(hours(2)),
  },
  {
    ...
    links: { prdId: "d_pm_1", graphNodeId: "g_eng", featureRequestId: "fr_2" }, createdAt: ago(days(3)), updatedAt: ago(days(1)),
  },
  {
    ...
    links: { prdId: "d_pm_1", graphNodeId: "g_design" }, createdAt: ago(days(3)), updatedAt: ago(hours(5)),
  },
  {
    ...
    links: { prdId: "d_pm_1", graphNodeId: "g_design" }, createdAt: ago(days(2)), updatedAt: ago(days(1)),
  },
  {
    ...
    links: { graphNodeId: "g_qa" }, createdAt: ago(days(1)), updatedAt: ago(hours(1)),
  },
  {
    ...
    links: { graphNodeId: "g_qa" }, createdAt: ago(days(2)), updatedAt: ago(days(1)),
  },
  {
    ...
    links: { graphNodeId: "g_sales", meetingId: "m_1" }, createdAt: ago(days(1)), updatedAt: ago(mins(50)),
  },
  {
  ...
  },
  {
    ...
    links: { prdId: "d_pm_1", graphNodeId: "g_eng" }, createdAt: ago(days(2)), updatedAt: ago(days(1)),
  },
  {
    ...
    links: { graphNodeId: "g_design" }, createdAt: ago(days(6)), updatedAt: ago(days(3)),
  },
];
