...
def _baseline_integrations(workspace_id: str) -> list:
    ...
    return [
        ...
        integ(
            ...
            name="Google Drive",
            category="Product",
            description="Docs, Sheets and Slides as company knowledge.",
            status="disconnected",
        ),
        integ(
            key="fireflies",
            ...
            description="Meeting transcripts and action items as signals.",
            status="coming-soon",
        ),
        integ(
            key="circleback",
            name="Circleback",
            category="Conferencing",
            description="Meeting notes and action items as signals.",
            status="coming-soon",
        ),
        integ(
            key="notion",
        ...
        integ(
            ...
            name="Google Meet",
            category="Conferencing",
            description="Call transcripts as signals.",
            status="coming-soon",
        ),
        integ(
            key="zoom",
        ...
        integ(
            ...
            name="Salesforce",
            category="CRM",
            description="Accounts and deals as context.",
            status="coming-soon",
        ),
        integ(
            key="hubspot",
...
async def ensure_integrations(db: AsyncSession, workspace_id: str = "ws_default") -> None:
    ...
    existing = set(
        (await db.execute(select(models.Integration.key).where(models.Integration.workspace_id == workspace_id)))
        .scalars()
        .all()
    )
