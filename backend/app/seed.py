...
def _baseline_integrations(workspace_id: str) -> list:
    ...
    return [
        ...
        integ(key="slack", name="Slack", category="Communication",
              ...
              status="disconnected"),
        integ(key="google-drive", name="Google Drive", category="Product",
              description="Docs, Sheets and Slides as company knowledge.",
              status="disconnected"),
        integ(key="fireflies", name="Fireflies", category="Conferencing",
              description="Meeting transcripts and action items as signals.",
              status="coming-soon"),
        integ(key="circleback", name="Circleback", category="Conferencing",
